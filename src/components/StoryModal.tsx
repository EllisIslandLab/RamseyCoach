      ...
      >
        ...
        <div className="prose prose-lg max-w-none">
          <p className="text-secondary-700 mb-4">
            ...
            out. If there was an activity we were compelled to do, once we signed up for it, we
            were heavily encouraged to follow through even if we didn&apos;t like it while in the
            thick of things.
          </p>
