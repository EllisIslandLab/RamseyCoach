    ...
    <footer className="bg-secondary-800 text-secondary-200">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-secondary-300">[City, State ZIP]</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-secondary-300">Mon-Fri: 8:00 AM - 5:00 PM EST</span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-secondary-700">
          ...
          {/* Disclaimer */}
          <p className="text-secondary-500 text-xs mt-6 text-center">
            This is an independent coaching practice. Not affiliated with or endorsed by Dave Ramsey or Ramsey Solutions.
            Financial coaching services are educational in nature and do not constitute financial, legal, or tax advice.
          </p>
        </div>
      </div>
    </footer>
